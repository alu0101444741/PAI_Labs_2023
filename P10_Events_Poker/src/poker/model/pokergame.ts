...
export class PokerGame {
  public static readonly CARDS_PER_HAND: number = 5;
  public readonly PLAYER_ONE: PokerPlayer;
  public readonly PLAYER_TWO: PokerPlayer;
  public readonly DECK: Deck;

  private gameStarted: boolean = false;
  private iterationButtonPlayer: PokerPlayer;
  ...
  */
  public playUntilPokerHand(pokerHand: string): number {
    let iterationsNeeded: number = 0;
    let validPokerHand: boolean = false;
    for(const hand of PokerHand.POKER_HANDS) if (pokerHand === hand) validPokerHand = true;
    ...
    if (this.PLAYER_ONE.getHand().getLabel() === pokerHand) this.iterationButtonPlayer = this.PLAYER_ONE;
    else if (this.PLAYER_TWO.getHand().getLabel() === pokerHand) this.iterationButtonPlayer = this.PLAYER_TWO;
    this.DECK.sort();
  ...
  public getIterationButtonPlayer(): PokerPlayer {
