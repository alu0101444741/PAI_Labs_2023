...
describe('PokerHand', () => {
  let handOne: PokerHand, handTwo: PokerHand;  

  test('Classify Straight Flush properly', () => {
    let straightFlushOne: Card[] = [new Card('Hearts', 2), new Card('Hearts', 3), new Card('Hearts', 4), new Card('Hearts', 5), new Card('Hearts', 6)];
    let straightFlushTwo: Card[] = [new Card('Hearts', 1), new Card('Hearts', 10), new Card('Hearts', 11), new Card('Hearts', 12), new Card('Hearts', 13)];
  ...
  test('Classify Four of a Kind properly', () => {
    let fourKindOne: Card[] = [new Card('Hearts', 2), new Card('Clubs', 2), new Card('Spades', 2), new Card('Diamonds', 2), new Card('Hearts', 8)]
    let fourKindTwo: Card[] = [new Card('Hearts', 1), new Card('Clubs', 1), new Card('Spades', 1), new Card('Diamonds', 1), new Card('Hearts', 8)]
  ...
  test('Classify Full House properly', () => {
    let fourKindOne: Card[] = [new Card('Hearts', 2), new Card('Clubs', 2), new Card('Spades', 2), new Card('Diamonds', 8), new Card('Hearts', 8)]
    let fourKindTwo: Card[] = [new Card('Hearts', 13), new Card('Clubs', 1), new Card('Spades', 1), new Card('Diamonds', 1), new Card('Hearts', 13)]
    handOne = new PokerHand(fourKindOne);
    handTwo = new PokerHand(fourKindTwo);
  ...
  test('Classify Flush properly', () => {
    let flushOne: Card[] = [new Card('Hearts', 2), new Card('Hearts', 10), new Card('Hearts', 5), new Card('Hearts', 1), new Card('Hearts', 8)]
    let flushTwo: Card[] = [new Card('Clubs', 2), new Card('Clubs', 10), new Card('Clubs', 11), new Card('Clubs', 12), new Card('Clubs', 13)]
  ...
  test('Classify Straight properly', () => {
    let straightOne: Card[] = [new Card('Hearts', 2), new Card('Hearts', 3), new Card('Hearts', 4), new Card('Hearts', 5), new Card('Spades', 6)];
    let straightTwo: Card[] = [new Card('Diamonds', 1), new Card('Spades', 10), new Card('Hearts', 11), new Card('Hearts', 12), new Card('Clubs', 13)];
  ...
  test('Classify Three of a Kind properly', () => {
    let threeKindOne: Card[] = [new Card('Hearts', 2), new Card('Clubs', 2), new Card('Spades', 10), new Card('Diamonds', 2), new Card('Hearts', 8)]
    let threeKindTwo: Card[] = [new Card('Hearts', 13), new Card('Clubs', 1), new Card('Spades', 1), new Card('Diamonds', 1), new Card('Hearts', 8)]
  ...
  test('Classify Two Pair properly', () => {
    let twoPairOne: Card[] = [new Card('Hearts', 2), new Card('Clubs', 2), new Card('Spades', 10), new Card('Diamonds', 5), new Card('Hearts', 10)]
    let twoPairTwo: Card[] = [new Card('Hearts', 13), new Card('Clubs', 1), new Card('Spades', 13), new Card('Diamonds', 1), new Card('Hearts', 8)]
  ...
  test('Classify Pair properly', () => {
    let pairOne: Card[] = [new Card('Hearts', 2), new Card('Clubs', 3), new Card('Spades', 11), new Card('Diamonds', 2), new Card('Hearts', 10)]
    let pairTwo: Card[] = [new Card('Hearts', 13), new Card('Clubs', 1), new Card('Spades', 13), new Card('Diamonds', 3), new Card('Hearts', 8)]
  ...
  test('Classify Highest Card properly', () => {
    let highestCardOne: Card[] = [new Card('Hearts', 2), new Card('Clubs', 3), new Card('Spades', 10), new Card('Diamonds', 5), new Card('Hearts', 11)]
    let highestCardTwo: Card[] = [new Card('Hearts', 2), new Card('Clubs', 1), new Card('Spades', 13), new Card('Diamonds', 3), new Card('Hearts', 8)]
