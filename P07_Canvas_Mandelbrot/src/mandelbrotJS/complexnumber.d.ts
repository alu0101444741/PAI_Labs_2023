...
export class ComplexNumber {
    ...
    */
    constructor(real: any, imaginary: any, color?: string);
    real: any;
    imaginary: any;
    color: string;
    /**
    ...
    * @return result on a new instance
    */
    multiply(complexNumber: any): ComplexNumber;
    /**
