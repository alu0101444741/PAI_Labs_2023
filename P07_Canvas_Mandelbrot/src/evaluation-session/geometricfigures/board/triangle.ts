...
export class Triangle extends Polygon { 
  ...
  public getArea(): number {
    let firstEdgeLength: number = this.edges[0].getLength();
    let secondEdgeLength: number = this.edges[1].getLength();
    let thirdEdgeLength: number = this.edges[2].getLength();
    let semiperimeter: number = this.computePerimeter() / 2;
